...
function peg$parse(input, options) {
  ...
  var peg$e23 = peg$otherExpectation("literal");
  var peg$e24 = peg$otherExpectation("string");
  var peg$e25 = peg$otherExpectation("character class");
  var peg$e26 = peg$classExpectation([["0", "9"]], false, false);
  var peg$e27 = peg$literalExpectation(".", false);
  var peg$e28 = peg$otherExpectation("code block");
  ...
  var peg$f10 = function(exact, delimiter) {
        return [exact, exact, extractOptional(delimiter, 2)];
      };
  var peg$f11 = function(min, max, delimiter) {
      return [
  ...
  var peg$f12 = function(value) { return { constant: true, value: value, location: location() }; };
  var peg$f13 = function(value) { return { constant: false, value: value[0], location: location() }; };
  ...
  var peg$f17 = function(name) { return [name, location()]; };
  var peg$f18 = function(head, tail) { return head + tail.join(""); };
  var peg$f19 = function(sequence) { return sequence; };
  var peg$f20 = function(value, ignoreCase) {
        return {
          type: "literal",
          value: value,
  ...
  var peg$f23 = function(inverted, parts, ignoreCase) {
        return {
          type: "class",
  ...
  var peg$f24 = function(begin, end) {
  ...
  var peg$f34 = function() { return { type: "any", location: location() }; };
  var peg$f35 = function(code) { return code; };
  var peg$f36 = function() { error("Unbalanced brace."); };
  var peg$f37 = function(digits) { return parseInt(digits); };
