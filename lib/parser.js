...
function peg$sandbox(input, options, text, offset, range, location, expected, error) {
  function sandbox0(input, options, text, offset, range, location, expected, error) {
    ...
    return {
      ...
      3: function(attributes, name, expression) {
      return {
        type: "rule",
        name: name[0],
    ...
    return {
      ...
      10: function(operator, expression) {
      return {
      ...
      11: function(expression, operator) {
      return {
      ...
      12: function(expression, operator) {
      let min = operator[0];
      let max = operator[1];
      ...
      13: function(exact, delimiter) {
      return [exact, exact, delimiter];
    },
      14: function(min, max, delimiter) {
    return [
      ...
      15: function(value) { return { constant: true, value: value, location: location() }; },
      16: function(value) { return { constant: false, value: value[0], location: location() }; },
    ...
    return addComment(comment, false);
      ...
      23: function(name) { return [name, location()]; },
      24: function(head, tail) { return head + tail.join(""); },
      25: function(sequence) { return sequence; },
      26: function(value, ignoreCase) {
      return {
        type: "literal",
        value: value,
      ...
      27: function(chars) { return chars.join(""); },
      28: function() { return text(); },
      29: function(inverted, parts, ignoreCase) {
      return {
        type: "class",
      ...
      31: function() { return ""; },
      32: function() { return "\0"; },
      33: function() { return "\b"; },
      34: function() { return "\f"; },
      35: function() { return "\n"; },
      36: function() { return "\r"; },
      37: function() { return "\t"; },
      38: function() { return "\v"; },
      39: function(digits) {
      return String.fromCharCode(parseInt(digits, 16));
    },
      40: function() { return { type: "any", location: location() }; },
      41: function() { error("Unbalanced brace."); },
      42: function(digits) { return parseInt(digits); },
    };
  }

  return sandbox0(input, options, text, offset, range, location, expected, error);
}
...
function peg$parse(input, options) {
  ...
  var peg$e2 = peg$otherExpectation("attribute");
  ...
  var peg$e26 = peg$otherExpectation("literal");
  var peg$e27 = peg$otherExpectation("string");
  var peg$e28 = peg$otherExpectation("character class");
  var peg$e29 = peg$classExpectation([["0", "9"]], false, false);
  var peg$e30 = peg$literalExpectation(".", false);
  var peg$e31 = peg$otherExpectation("code block");
  ...
  var peg$f0 = peg$functions[0];
  var peg$f1 = peg$functions[1];
  var peg$f2 = peg$functions[2];
  var peg$f3 = peg$functions[3];
  var peg$f4 = peg$functions[4];
  var peg$f5 = peg$functions[5];
  var peg$f6 = peg$functions[6];
  var peg$f7 = peg$functions[7];
  var peg$f8 = peg$functions[8];
  var peg$f9 = peg$functions[9];
  var peg$f10 = peg$functions[10];
  var peg$f11 = peg$functions[11];
  var peg$f12 = peg$functions[12];
  var peg$f13 = peg$functions[13];
  var peg$f14 = peg$functions[14];
  var peg$f15 = peg$functions[15];
  var peg$f16 = peg$functions[16];
  var peg$f17 = peg$functions[17];
  var peg$f18 = peg$functions[18];
  var peg$f19 = peg$functions[19];
  var peg$f20 = peg$functions[20];
  var peg$f21 = peg$functions[21];
  var peg$f22 = peg$functions[22];
  var peg$f23 = peg$functions[23];
  var peg$f24 = peg$functions[24];
  var peg$f25 = peg$functions[25];
  var peg$f26 = peg$functions[26];
  var peg$f27 = peg$functions[27];
  var peg$f28 = peg$functions[28];
  var peg$f29 = peg$functions[29];
  var peg$f30 = peg$functions[30];
  var peg$f31 = peg$functions[31];
  var peg$f32 = peg$functions[32];
  var peg$f33 = peg$functions[33];
  var peg$f34 = peg$functions[34];
  var peg$f35 = peg$functions[35];
  var peg$f36 = peg$functions[36];
  var peg$f37 = peg$functions[37];
  var peg$f38 = peg$functions[38];
  var peg$f39 = peg$functions[39];
  var peg$f40 = peg$functions[40];
  var peg$f41 = peg$functions[41];
  var peg$f42 = peg$functions[42];
  ...
  function peg$parseAttributeValue() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parseBalancedParenthesis();
      if (s2 === peg$FAILED) {
        s2 = null;
      }
  ...
  function peg$parseBalancedParenthesis() {
    ...
    if (s2 === peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        s4 = peg$parseBalancedParenthesis();
        if (s4 !== peg$FAILED) {
          if (input.charCodeAt(peg$currPos) === 41) {
            s5 = peg$c5;
            peg$currPos++;
  ...
  function peg$parseEOS() {
    ...
    s0 = peg$currPos;
    s1 = peg$parse__();
    if (peg$silentFails === 0) { peg$expect(peg$e32); }
