...
function peg$parse(input, options) {
  ...
  var peg$e1 = peg$otherExpectation("attribute");
  ...
  function peg$parseRule() {
    ...
    r2 = peg$parseIdentifierName();
    if (r2 !== peg$FAILED) {
      r3 = peg$parse__();
      r4 = peg$currPos;
      r5 = peg$parseStringLiteral();
      if (r5 !== peg$FAILED) {
        r6 = peg$parse__();
        r5 = r5;
        r4 = r5;
      ...
      if (r5 !== peg$FAILED) {
        r6 = peg$parse__();
        r7 = peg$parseChoiceExpression();
        r8 = peg$parseEOS();
        if (r8 !== peg$FAILED) {
          peg$savedPos = r0;
          r1 = peg$f2(r1, r2, r4, r7);
          r0 = r1;
        } else {
          peg$currPos = r0;
          r0 = peg$FAILED;
  ...
  function peg$parseBalancedParenthesis() {
    ...
    if (r2 === peg$FAILED) {
      ...
      if (r3 !== peg$FAILED) {
        r4 = peg$parseBalancedParenthesis();
        if (r4 !== peg$FAILED) {
          if (input.charCodeAt(peg$currPos) === 41) {
            r5 = peg$c4;
            peg$currPos++;
    ...
    if (r1 !== peg$FAILED) {
      r0 = input.substring(r0, peg$currPos);
    } else {
      r0 = r1;
    }
  ...
  function peg$parseActionExpression() {
    ...
    r0 = peg$currPos;
    r1 = peg$parseSequenceExpression();
    r2 = peg$currPos;
    r3 = peg$parse__();
    r4 = peg$parseCodeBlock();
    if (r4 !== peg$FAILED) {
      r3 = r4;
      r2 = r3;
    } else {
  ...
  function peg$parseLabeledExpression() {
    ...
    if (r0 === peg$FAILED) {
      ...
      if (r1 !== peg$FAILED) {
        ...
        if (r3 !== peg$FAILED) {
          r4 = peg$parse__();
          r5 = peg$parsePrefixedExpression();
          if (r5 !== peg$FAILED) {
            peg$savedPos = r0;
            r1 = peg$f8(r1, r5);
            r0 = r1;
  ...
  function peg$parsePrefixedExpression() {
    ...
    r0 = peg$currPos;
    r1 = peg$parsePrefixedOperator();
    if (r1 !== peg$FAILED) {
      r2 = peg$parse__();
      r3 = peg$parseSuffixedExpression();
      if (r3 !== peg$FAILED) {
        peg$savedPos = r0;
        r1 = peg$f9(r1, r3);
        r0 = r1;
  ...
  function peg$parseSuffixedExpression() {
    ...
    r0 = peg$currPos;
    r1 = peg$parsePrimaryExpression();
    if (r1 !== peg$FAILED) {
      r2 = peg$parse__();
      r3 = peg$parseSuffixedOperator();
      if (r3 !== peg$FAILED) {
        peg$savedPos = r0;
        r1 = peg$f10(r1, r3);
        r0 = r1;
  ...
  function peg$parseSemanticPredicateExpression() {
    ...
    r0 = peg$currPos;
    r1 = peg$parseSemanticPredicateOperator();
    if (r1 !== peg$FAILED) {
      r2 = peg$parse__();
      r3 = peg$parseCodeBlock();
      if (r3 !== peg$FAILED) {
        peg$savedPos = r0;
        r1 = peg$f18(r1, r3);
        r0 = r1;
  ...
  function peg$parseMultiLineComment() {
    ...
    if (r1 !== peg$FAILED) {
      ...
      r2 = input.substring(r2, peg$currPos);
      if (input.substr(peg$currPos, 2) === peg$c29) {
        r3 = peg$c29;
        peg$currPos += 2;
      } else {
    ...
    if (r0 === peg$FAILED) {
      ...
      if (r0 === peg$FAILED) {
        ...
        if (r0 === peg$FAILED) {
          ...
          if (r1 !== peg$FAILED) {
            r2 = peg$parseUnicodeEscapeSequence();
            if (r2 !== peg$FAILED) {
              peg$savedPos = r0;
              r1 = peg$f23(r2);
              r0 = r1;
  ...
  function peg$parseStringLiteral() {
    ...
    if (r1 !== peg$FAILED) {
      r2 = [];
      r3 = peg$parseDoubleStringCharacter();
      while (r3 !== peg$FAILED) {
        r2.push(r3);
        r3 = peg$parseDoubleStringCharacter();
      }
    ...
    if (r0 === peg$FAILED) {
      ...
      if (r1 !== peg$FAILED) {
        r2 = [];
        r3 = peg$parseSingleStringCharacter();
        while (r3 !== peg$FAILED) {
          r2.push(r3);
          r3 = peg$parseSingleStringCharacter();
        }
  ...
  function peg$parseCharacterClassMatcher() {
    ...
    if (r1 !== peg$FAILED) {
      ...
      r3 = [];
      r4 = peg$parseClassCharacterRange();
      if (r4 === peg$FAILED) {
  ...
  function peg$parseUnicodeEscapeSequence() {
    ...
    if (r1 !== peg$FAILED) {
      ...
      if (r4 !== peg$FAILED) {
        r5 = peg$parseHexDigit();
        if (r5 !== peg$FAILED) {
          r6 = peg$parseHexDigit();
          if (r6 !== peg$FAILED) {
            r7 = peg$parseHexDigit();
            if (r7 !== peg$FAILED) {
              r4 = [r4, r5, r6, r7];
              r3 = r4;
            } else {
  ...
  function peg$parseInt() {
    ...
    if (r2 !== peg$FAILED) {
      r1 = input.substring(r1, peg$currPos);
    } else {
      r1 = r2;
    }
    if (r1 !== peg$FAILED) {
  ...
  function peg$parseEOS() {
    ...
    if (r0 === peg$FAILED) {
      r0 = peg$currPos;
      r1 = peg$parse_();
      r2 = peg$parseSingleLineComment();
      if (r2 === peg$FAILED) {
        r2 = null;
      }
      r3 = peg$parseLineTerminatorSequence();
      if (r3 !== peg$FAILED) {
        r1 = [r1, r2, r3];
        r0 = r1;
      } else {
