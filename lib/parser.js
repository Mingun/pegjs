...
function peg$parse(input, options) {
  ...
  var peg$f10 = function(exact) { return [exact.value, exact]; };
  ...
  var peg$f12 = function(value) { return { value: value, location: location() }; };
  ...
  var peg$f22 = function(inverted, parts, ignoreCase) {
        return {
          type: "class",
  ...
  var peg$f23 = function(begin, end) {
  ...
  var peg$f34 = function(code) { return code; };
  var peg$f35 = function() { error("Unbalanced brace."); };
  var peg$f36 = function(digits) { return parseInt(digits); };
