...
function peg$parse(input, options) {
  ...
  var peg$f0 = function(imports, initializer, rules) {
        return {
          type: "grammar",
          imports: imports,
  ...
  var peg$f1 = function(alias, path) {
        return {
          type: "import",
          path: path,
          alias: alias,
  ...
  var peg$f3 = function(attributes, name, expression) {
        return {
          type: "rule",
          name: name[0],
  ...
  var peg$f10 = function(operator, expression) {
        return {
  ...
  var peg$f13 = function(exact, delimiter) {
        return [exact, exact, delimiter];
      };
  var peg$f14 = function(min, max, delimiter) {
      return [
  ...
  var peg$f15 = function(value) { return { constant: true, value: value, location: location() }; };
  var peg$f16 = function(value) { return { constant: false, value: value[0], location: location() }; };
  ...
  var peg$f18 = function(namespace, name) {
        return {
          type: "rule_ref",
          namespace: namespace,
          name: name,
  ...
  var peg$f19 = function(namespace) {
        return {
          type: "rule_ref",
          namespace: namespace,
          name: null,
  ...
  var peg$f21 = function(comment) {
      return addComment(comment, true);
    };
  var peg$f22 = function(comment) {
      return addComment(comment, false);
    };
  var peg$f23 = function(name) { return [name, location()]; };
  var peg$f24 = function(head, tail) { return head + tail.join(""); };
  ...
  var peg$f29 = function(inverted, parts, ignoreCase) {
        return {
          type: "class",
  ...
  var peg$f30 = function(begin, end) {
  ...
  var peg$f40 = function() { return { type: "any", location: location() }; };
  var peg$f41 = function() { error("Unbalanced brace."); };
  var peg$f42 = function(digits) { return parseInt(digits); };
