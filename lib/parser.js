...
function peg$sandbox(input, options, text, offset, range, location, expected, error) {
  function sandbox0(input, options, text, offset, range, location, expected, error) {
    ...
    return {
      ...
      2: function(attributes, name, displayName, expression) {
      return {
        type: "rule",
        name: name,
    ...
    return {
      ...
      9: function(operator, expression) {
      return {
      ...
      10: function(expression, operator) {
      return {
      ...
      12: function(exact, delimiter) {
      return [exact, exact, delimiter];
    },
      13: function(min, max, delimiter) {
    return [
      ...
      14: function(value) { return { constant: true, value: value, location: location() }; },
      15: function(value) { return { constant: false, value: value[0], location: location() }; },
    ...
    return addComment(comment, false);
      ...
      21: function(name) { return [name, location()]; },
      22: function(head, tail) { return head + tail.join(""); },
      23: function(sequence) { return sequence; },
      24: function(value, ignoreCase) {
      return {
        type: "literal",
        value: value,
      ...
      25: function(chars) { return chars.join(""); },
      26: function() { return text(); },
      27: function(inverted, parts, ignoreCase) {
      return {
        type: "class",
      ...
      29: function() { return ""; },
      30: function() { return "\0"; },
      31: function() { return "\b"; },
      32: function() { return "\f"; },
      33: function() { return "\n"; },
      34: function() { return "\r"; },
      35: function() { return "\t"; },
      36: function() { return "\v"; },
      37: function(digits) {
      return String.fromCharCode(parseInt(digits, 16));
    },
      38: function() { return { type: "any", location: location() }; },
      39: function() { error("Unbalanced brace."); },
      40: function(digits) { return parseInt(digits); },
    };
  }
