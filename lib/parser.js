...
function peg$parse(input, options) {
  ...
  var peg$e24 = peg$otherExpectation("literal");
  var peg$e25 = peg$otherExpectation("string");
  var peg$e26 = peg$otherExpectation("character class");
  var peg$e27 = peg$classExpectation([["0", "9"]], false, false);
  var peg$e28 = peg$literalExpectation(".", false);
  var peg$e29 = peg$otherExpectation("code block");
  ...
  var peg$f11 = function(exact, delimiter) {
        return [exact, exact, delimiter];
      };
  var peg$f12 = function(min, max, delimiter) {
      return [
  ...
  var peg$f13 = function(value) { return { constant: true, value: value, location: location() }; };
  var peg$f14 = function(value) { return { constant: false, value: value[0], location: location() }; };
  ...
  var peg$f17 = function(operator, code) {
        return {
  ...
  var peg$f18 = function(comment) {
      return addComment(comment, true);
    };
  var peg$f19 = function(comment) {
      return addComment(comment, false);
    };
  var peg$f20 = function(name) { return [name, location()]; };
  var peg$f21 = function(head, tail) { return head + tail.join(""); };
  ...
  var peg$f38 = function(code) { return code; };
