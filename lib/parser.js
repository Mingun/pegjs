...
function peg$parse(input, options) {
  ...
  var peg$f17 = function(comment) {
      return addComment(comment, true);
    };
  var peg$f18 = function(comment) {
      return addComment(comment, false);
    };
  var peg$f19 = function(name) { return [name, location()]; };
  var peg$f20 = function(head, tail) { return head + tail.join(""); };
  ...
  var peg$f37 = function(code) { return code; };
  var peg$f38 = function() { error("Unbalanced brace."); };
