...
function peg$sandbox(input, options, text, offset, range, location, expected, error) {
  ...
  return [
    ...
    function(attributes, name, displayName, expression) {
      return {
        type: "rule",
        name: name,
    ...
    function(exact, delimiter) {
      return [exact, exact, delimiter];
    },
    function(min, max, delimiter) {
    return [
    ...
    function(value) { return { constant: true, value: value, location: location() }; },
    function(value) { return { constant: false, value: value[0], location: location() }; },
    function(expression) {
    ...
    function(name) { return [name, location()]; },
    ...
    function() { error("Unbalanced brace."); },
    function(digits) { return parseInt(digits); },
  ];
}
