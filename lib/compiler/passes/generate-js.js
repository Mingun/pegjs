      ...
      while (ip < end) {
        switch (bc[ip]) {
          ...
          case op.PUSH_CURR_POS:      // PUSH_CURR_POS
            parts.push(resStack.push("peg$currPos"));
            ip++;
            break;
          ...
          case op.POP_CURR_POS:       // POP_CURR_POS
            parts.push("peg$currPos = " + resStack.pop() + ";");
            ip++;
            break;
          ...
          case op.TEXT:               // TEXT
            parts.push(
              resStack.push("input.substring(" + resStack.pop() + ", peg$currPos)")
            );
            ip++;
            break;
          ...
          case op.LOAD_SAVED_POS:     // LOAD_SAVED_POS p
            parts.push("peg$savedPos = " + resStack.index(bc[ip + 1]) + ";");
            ip += 2;
            break;
