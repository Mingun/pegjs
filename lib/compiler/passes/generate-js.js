      ...
      while (ip < end) {
        switch (bc[ip]) {
          ...
          case op.PUSH_CURR_POS:      // PUSH_CURR_POS
            parts.push(posStack.push("peg$currPos"));
            ip++;
            break;

          case op.LOAD_CURR_POS:      // LOAD_CURR_POS
            parts.push("peg$currPos = " + posStack.top() + ";");
            ip++;
            break;
          ...
          case op.TEXT:               // TEXT
            resStack.pop();
            parts.push(
              resStack.push("input.substring(" + posStack.top() + ", peg$currPos)")
            );
            ip++;
            break;
          ...
          case op.LOAD_SAVED_POS:     // LOAD_SAVED_POS
            parts.push("peg$savedPos = " + posStack.top() + ";");
            ip++;
            break;
