...
function generateJS(ast, options) {
  ...
  function generateInterpreter() {
    ...
    parts.push([
      ...
      "",
      "        case " + op.GET + ":",                // GET n, i
      "          params = stack[stack.length - 1 - bc[ip + 2]];",
      ...
      indent10(generateCondition("stack[stack.length - 1].length < bc[ip + 1]", 1)),
      "",
      ...
      indent10(generateCondition(
                   "stack[stack.length - 1].length < stack[stack.length - 1 - bc[ip + 1]]",
                   1
                 )),
      "",
