...
let checkTemplateArgs = require("./passes/check-template-args");
...
let ruleRef2ParamRef = require("./passes/rule-ref2param-ref");
...
let compiler = {
  ...
  passes: {
    precheck: {
      ruleRef2ParamRef: ruleRef2ParamRef
    },
    check: {
      ...
      checkTemplateArgs: checkTemplateArgs,
